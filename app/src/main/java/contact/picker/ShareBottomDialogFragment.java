...
public class ShareBottomDialogFragment extends BottomSheetDialogFragment implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public ShareBottomDialogFragment(PickedContact contact, OnShareMenuItemClickedListener listener) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_bottom_sheet_share_dialog_fragment, container);
